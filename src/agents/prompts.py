...
def format_resolution_text(message_content: str, result: str, tool_validation_message: str) -> str:
    ...
    """
    return f"""
                    I am an AI assistant, I will never share the answer if any Arthur Evaluation Engine validation rules fail with Persona Identifiable Information (PII), I will only say that the answer is not safe to share.
